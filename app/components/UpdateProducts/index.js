...
class UpdateProducts extends React.PureComponent {
         ...
         <form style={formStyle}>
          ...
          <legend style={legendStyle}> Product Update</legend>
           ...
           <p style={inputSetStyle}>
            <label style={labelStyle}> Which product is changing?</label>
            <select id="products" > <option> products here</option></select>         </p>    

          <p style={inputSetStyle}>
            <label style={labelStyle}> Select category</label>
            <select id="categories" > <option> categories here</option></select>       </p>            
